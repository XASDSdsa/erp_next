...
frappe.help.help_links["permission-manager"] = [
	{
		label: __("Role Based Permissions"),
		url: docsUrl + "user/manual/en/role-based-permissions",
	},
	{
		label: __("Managing Perm Level in Permissions Manager"),
...
frappe.help.help_links["Form/Data Import"] = [
	{
		label: __("Importing and Exporting Data"),
...
frappe.help.help_links["List/Cheque Print Template"] = [
	{
		label: __("Cheque Print Template"),
...
frappe.help.help_links["Form/Quotation"] = [
	{ label: __("Quotation"), url: docsUrl + "user/manual/en/quotation" },
	{
		label: __("Applying Discount"),
	...
	{
		label: __("Applying Margin"),
		url: docsUrl + "user/manual/en/adding-margin",
	},
];

frappe.help.help_links["List/Customer"] = [
	{ label: __("Customer"), url: docsUrl + "user/manual/en/customer" },
	{
...
frappe.help.help_links["List/Sales Order"] = [
	...
	{
		label: __("Recurring Sales Order"),
...
frappe.help.help_links["List/Supplier"] = [{ label: __("Supplier"), url: docsUrl + "user/manual/en/supplier" }];

frappe.help.help_links["Form/Supplier"] = [{ label: __("Supplier"), url: docsUrl + "user/manual/en/supplier" }];
...
frappe.help.help_links["List/Purchase Order"] = [
	...
	{
		label: __("Recurring Purchase Order"),
		url: docsUrl + "user/manual/en/auto-repeat",
	},
];
...
frappe.help.help_links["List/Workflow"] = [{ label: __("Workflow"), url: docsUrl + "user/manual/en/workflows" }];
...
frappe.help.help_links["List/Company"] = [
	...
	{
		label: __("Delete All Related Transactions for a Company"),
...
frappe.help.help_links["Form/Sales Invoice"] = [
	...
	{
		label: __("Accounts Opening Balance"),
	...
	{
		label: __("Recurring Sales Invoice"),
		url: docsUrl + "user/manual/en/auto-repeat",
	},
];
...
frappe.help.help_links["point-of-sale"] = [
	{
		label: __("Point of Sale Invoice"),
...
frappe.help.help_links["List/POS Profile"] = [
	{
		label: __("Point of Sale Profile"),
...
frappe.help.help_links["List/Purchase Invoice"] = [
	...
	{
		label: __("Recurring Purchase Invoice"),
		url: docsUrl + "user/manual/en/auto-repeat",
	},
];
...
frappe.help.help_links["List/Asset"] = [
	{
		label: __("Managing Fixed Assets"),
...
frappe.help.help_links["Tree/Cost Center"] = [
	{ label: __("Budgeting"), url: docsUrl + "user/manual/en/budgeting" },
];

//Stock

frappe.help.help_links["List/Item"] = [
	{ label: __("Item"), url: docsUrl + "user/manual/en/item" },
	{
		label: __("Item Price"),
...
frappe.help.help_links["List/Installation Note"] = [
	{
		label: __("Installation Note"),
		url: docsUrl + "user/manual/en/installation-note",
	},
];

frappe.help.help_links["List/Budget"] = [{ label: __("Budgeting"), url: docsUrl + "user/manual/en/budgeting" }];
...
frappe.help.help_links["List/Material Request"] = [
	...
	{
		label: __("Auto-creation of Material Request"),
...
frappe.help.help_links["Form/Stock Entry"] = [
	{ label: __("Stock Entry"), url: docsUrl + "user/manual/en/stock-entry" },
	{
		label: __("Stock Entry Types"),
		url: docsUrl + "user/manual/en/stock-entry-purpose",
	},
	{
		label: __("Repack Entry"),
...
frappe.help.help_links["Tree/Warehouse"] = [
	{ label: __("Warehouse"), url: docsUrl + "user/manual/en/warehouse" },
];

frappe.help.help_links["List/Serial No"] = [
	{ label: __("Serial No"), url: docsUrl + "user/manual/en/serial-no" },
];
...
frappe.help.help_links["List/Batch"] = [{ label: __("Batch"), url: docsUrl + "user/manual/en/batch" }];

frappe.help.help_links["Form/Batch"] = [{ label: __("Batch"), url: docsUrl + "user/manual/en/batch" }];
...
frappe.help.help_links["Form/Lead"] = [{ label: __("Lead"), url: docsUrl + "user/manual/en/lead" }];

frappe.help.help_links["Form/Opportunity"] = [
	{ label: __("Opportunity"), url: docsUrl + "user/manual/en/opportunity" },
];

frappe.help.help_links["Form/Address"] = [{ label: __("Address"), url: docsUrl + "user/manual/en/address" }];

frappe.help.help_links["Form/Contact"] = [{ label: __("Contact"), url: docsUrl + "user/manual/en/contact" }];

frappe.help.help_links["Form/Newsletter"] = [
	{ label: __("Newsletter"), url: docsUrl + "user/manual/en/newsletter" },
];

frappe.help.help_links["Form/Campaign"] = [{ label: __("Campaign"), url: docsUrl + "user/manual/en/campaign" }];
...
frappe.help.help_links["Form/Sales Person"] = [
	{
		label: __("Sales Person Target"),
		url: docsUrl + "user/manual/en/sales-person-target-allocation",
	},
	{
		label: __("Sales Person in Transactions"),
		url: docsUrl + "user/manual/en/sales-persons-in-the-sales-transactions",
	},
];
...
frappe.help.help_links["Form/BOM"] = [
	{
		label: __("Bill of Material"),
		url: docsUrl + "user/manual/en/bill-of-materials",
	},
	{
		label: __("Nested BOM Structure"),
